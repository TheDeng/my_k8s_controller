...
import (
	...
	versioned "github.com/TheDeng/my_k8s_controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/TheDeng/my_k8s_controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/TheDeng/my_k8s_controller/pkg/generated/listers/whu/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WhuV1().Students(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WhuV1().Students(namespace).Watch(context.TODO(), options)
			},
		},
		&whuv1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&whuv1.Student{}, f.defaultInformer)
}
